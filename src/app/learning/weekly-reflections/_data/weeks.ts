...
const weeks: Week[] = [
	{
		title: "Week 24, 2026 (June 9 - June 15)",
		href: "/learning/weekly-reflections/week-24",
		date: new Date("2025-06-15T12:00:00.000Z"),
	},
	{
		title: "Week 23, 2026 (June 2 - June 8)",
		href: "/learning/weekly-reflections/week-23",
		date: new Date("2025-06-08T12:00:00.000Z"),
	},
	{
...
export function getWeeksByMonth(): MonthGroup[] {
	const groupedWeeks = weeks.reduce((acc: { [key: string]: Week[] }, week) => {
		const monthYear = week.date.toLocaleString("ja-JP", {
			month: "long",
			year: "numeric",
		});
		if (!acc[monthYear]) {
