...
During the weekend, I did not do a lot of math as I got quite busy with meeting friends and also wasting time here and there. However, I finally managed to create a rough fulcrum for my next few months of learning: **deep learning architecture design and optimization**. I also made a [GitHub repository](https://github.com/sumitdotml/ml-deepdive) to record my project-based learning approach, and I have decided that my first project is going to be [building an autograd engine from scratch](https://github.com/sumitdotml/autograd)! This is going to be my main focus from here; I hope to finish this within a week.
