# Week 3, 2025 (Jan 14th - Jan 19th)

A 6-day week since this week started on Tuesday. I started seriously pursuing Python and PyTorch this week. Unfortunately, I could not get a lot of math done and it kind of sucks that it's becoming quite difficult for me to resume my previous habit of doing math daily. In my degense though, however, this is largely because of me focusing more on Python & PyTorch.
...
- Got to know about `torch.inference_mode()` and its efficiency compared to `torch.no_grad()` during inference
